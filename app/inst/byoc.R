...
chart_vars <- c('Total capacity (BTC)'='tot.capacity',
	...
	'Mean outbound base fee (msat)'='mean.base.msat.out',
	'Mean inbound base fee (msat)'='mean.base.msat.in',
	'Median outbound base fee (msat)'='median.base.msat.out',
	'Median inbound base fee (msat)'='median.base.msat.in',
	'Mean outbound fee rate (ppm)'='mean.rate.ppm.out',
	'Mean inbound fee rate (ppm)'='mean.rate.ppm.in',
	'Median outbound fee rate (ppm)'='median.rate.ppm.out',
	'Median inbound fee rate (ppm)'='median.rate.ppm.in',
